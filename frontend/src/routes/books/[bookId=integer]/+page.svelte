	...
	<div class="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-0 py-10 ">
		...
		<div class="md:w-2/5 space-y-4 p-3 ">
			...
			<div class="pt-6  t space-y-6  flex flex-col md:items-start items-center">
				<a href="/" class="rounded-full font-semibold bg-yellow-200 px-4 py-3 w-24 text-center uppercase">Pdf </a>
				<div class="flex flex-col md:items-start md:flex-row gap-6">
					<div class="flex items-center justify-center space-x-1">
						<Button btnClass="rounded-full border border-gray-600 h-12 w-12 text-3xl text-center font-bold text-2xl"
				...
				<div class="flex flex-col md:flex-row gap-6">
					<a href="/" class="rounded-full font-semibold border border-gray-700 px-4 py-3 w-48 text-center uppercase flex items-center space-x-2">
						<span><img src="/icons/cart.svg" class="h-5 w-5" alt="" srcset="" /></span> <span>add to cart</span></a
					>
				</div>
			</div>
		</div>
