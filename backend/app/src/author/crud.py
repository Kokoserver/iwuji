...
from app.src.media import crud as mediaCrud
from app.src.author import schemas
...
async def update_author(new_author_data: schemas.AuthorIn, request: Request, profile_img: UploadFile = None,) -> Message:
...
async def get_author(authorId: int) -> Message:
...
async def remove_author_data(authorId: int) -> None:
